...
class BookletTests: XCTestCase {
    ...
    func testBookletProperties() throws {
		let video = Video(id: 1,
                          ...
                          url: URL(fileURLWithPath: Bundle.main.path(forResource: "Coffee Run", ofType:"mp4")!) ,
                          duration: 184,
                          published: Date(),
                          imageURL: URL(string: "https://ddz4ak4pa3d19.cloudfront.net/cache/d1/e2/d1e23ccf3bdfa77b34ff2404c9403513.jpg")!)
		let booklet = VideoBooklet(video: video, delegate: VideoLibrary())
